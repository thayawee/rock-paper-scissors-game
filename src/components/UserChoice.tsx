...
const UserChoice = ({ userChoice, handleClick }: UserChoiceProps) => {
  return (
    <div className="container-user-choice flex flex-col justify-center items-center gap-[55px]">
      <div>
        {userChoice === "rock" ? (
          <>
            ...
            <p className="uppercase font-bold text-center text-[14px] tracking-[2px] text-orange-300 mt-[15px]">
              Player
            </p>
          </>
        ) : userChoice === "paper" ? (
